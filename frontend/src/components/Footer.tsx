...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-md px-lg py-sm flex flex-col md:flex-row justify-between items-center gap-sm pointer-events-none">
